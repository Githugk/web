  ...
  <div class="aside">
    ...
    <ul class="nav">
      ...
      <?php $judge = array('posts','post-add','categories'); ?>
      <li <?php echo in_array($current_page, $judge)? 'class="active"' : '' ?>>
        <a href="#menu-posts" <?php echo in_array($current_page, $judge)? ' ' : 'class="collapsed"' ?> data-toggle="collapse">
          <i class="fa fa-thumb-tack"></i>文章<i class="fa fa-angle-right"></i>
        </a>
        <ul id="menu-posts" class="collapse<?php echo in_array($current_page, $judge)? ' in' : '' ?>">
      ...
      <?php $judge2 = array('nav-menus','slides','settings'); ?>
      <li>
        <a href="#menu-settings" <?php echo in_array($current_page, $judge2)? '' : 'class="collapsed"' ?> data-toggle="collapse">
          <i class="fa fa-cogs"></i>设置<i class="fa fa-angle-right"></i>
        </a>
        <ul id="menu-settings" class="collapse<?php echo in_array($current_page, $judge2)? ' in' : '' ?>">
