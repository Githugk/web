      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>?id=<?php echo $current_edit_category['id']; ?>" method="post">
            ...
            <div class="form-group">
              ...
              <a  class="btn btn-primary" href="/admin/categories.php" >退出编辑</a>
            </div>
          </form>
          <?php else: ?>
        ...
        <div class="col-md-8">
          <div class="page-action">
            ...
            <a id="categories_btn_delete" class="btn btn-danger btn-sm" href="/admin/category-delete.php" style="display: none">批量删除</a>
          </div>
...
<?php include 'inc/sidebar.php'; ?>
  ...
  <script src="/static/assets/vendors/bootstrap/js/bootstrap.js"></script>
    ...
    $(function ($) {
      ...
      var $btnDelete = $('#categories_btn_delete')
